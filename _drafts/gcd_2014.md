...
Howard Jacob joked (or not) that the future of common disease is "phenotyping using an Apple watch and clinical sequencing". However, for that to be a reality, there are many barriers to overcome. Two key areas were discussed regarding what needs to happen to make clinical genomics happen:
